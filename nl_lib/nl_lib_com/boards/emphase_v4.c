...
/*******************************************************************************
	debug module
*******************************************************************************/
static PIN_CFG_T lpc_dbg_led_heartbeat = {
	.pinId  		= {5,3},
	.ioType 		= PIN_TYPE_GPIO,
	.gpioId 		= {2,12},
	.direction		= PIN_GPIO_DIR_OUT,
...
static PIN_CFG_T lpc_dbg_led_warning = {
	.pinId  		= {5,4},
	.ioType 		= PIN_TYPE_GPIO,
	.gpioId 		= {2,13},
	.direction		= PIN_GPIO_DIR_OUT,
...
static PIN_CFG_T lpc_dbg_led_cpu = {
	.pinId  		= {5,1},
	.ioType 		= PIN_TYPE_GPIO,
	.gpioId 		= {2,10},
	.direction		= PIN_GPIO_DIR_OUT,
...
static PIN_CFG_T lpc_dbg_led_usb = {
	.pinId  		= {5,2},
	.ioType 		= PIN_TYPE_GPIO,
	.gpioId 		= {2,11},
	.direction		= PIN_GPIO_DIR_OUT,
...
static DBG_PINS_T debug_pins = {
	.led_heartbeat 	= &lpc_dbg_led_heartbeat.gpioId,
	.led_warning	= &lpc_dbg_led_warning.gpioId,
	.led_error 		= &lpc_dbg_led_error.gpioId,
	.led_cpu		= &lpc_dbg_led_cpu.gpioId,
	.led_usb		= &lpc_dbg_led_usb.gpioId,
...
static void InitDebugPins(void)
{
	PIN_Config(&lpc_dbg_led_heartbeat);
	PIN_Config(&lpc_dbg_led_warning);
	PIN_Config(&lpc_dbg_led_error);
	PIN_Config(&lpc_dbg_led_cpu);
	PIN_Config(&lpc_dbg_led_usb);
