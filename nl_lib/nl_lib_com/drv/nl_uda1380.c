...
void UDA1380_Init(LPC_I2Cn_Type *I2Cx, uint8_t addr)
{
	...
	UDA1380_WriteReg(I2Cx, addr, UDA_REG_POWER_CTRL, (UDA_POWER_ON_PLL |
													  UDA_POWER_ON_HP  |
													  UDA_POWER_ON_DAC |
													  UDA_POWER_ON_BIAS |
													  UDA_POWER_ON_ADC_PGA_LR));
	...
	/* enable clocks */
	UDA1380_WriteReg(I2Cx, addr, UDA_REG_EVALM_CLK, (UDA_EVALM_CLK_DEFAULT |
														UDA_EVALM_CLK_SYSDIV_512_FS |
														UDA_EVALM_CLK_EN_DAC |
														UDA_EVALM_CLK_EN_ADC |
														UDA_EVALM_CLK_ADC_WSPLL |
														UDA_EVALM_CLK_DAC_WSPLL));
}
