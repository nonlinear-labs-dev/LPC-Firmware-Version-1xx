...
#ifdef C15_VERSION_4
	#define EMPHASE_IPC_PEDAL_1_PULLR_TO_RING	25
	#define EMPHASE_IPC_PEDAL_1_PULLR_TO_TIP	24
	#define EMPHASE_IPC_PEDAL_2_PULLR_TO_RING	23
	#define EMPHASE_IPC_PEDAL_2_PULLR_TO_TIP	22
	#define EMPHASE_IPC_PEDAL_3_PULLR_TO_RING	21
	#define EMPHASE_IPC_PEDAL_3_PULLR_TO_TIP	20
	#define EMPHASE_IPC_PEDAL_4_PULLR_TO_RING	19
	#define EMPHASE_IPC_PEDAL_4_PULLR_TO_TIP	18
...
uint32_t Emphase_IPC_M4_KeyBuffer_ReadBuffer(	IPC_KEY_EVENT_T* keyEvent,
												uint8_t maxNumOfMsgsToRead);
